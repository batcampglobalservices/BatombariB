    ...
    return (
        <CardLayout>
            <div className="p-8 h-full relative card_stylings transition">
                <img src={data?.image} alt={data?.name ? `${data.name} avatar` : 'Recommender avatar'} className="absolute z-10 right-10 -top-5 border-Green w-16 h-16  border-[3px] rounded-full m-0" />
